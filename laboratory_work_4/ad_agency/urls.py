...
urlpatterns = [
    ...
    path('client/create/', ClientCreateAPIView.as_view(), name='client-create'),
    path('client/<int:pk>/', ClientRUDAPIView.as_view(), name='client'),
    path('client/filter/', ClientFilterView.as_view()),

    path('servicespl/', ServicesPLListAPIView.as_view()),
    path('servicespl/create/', ServicesPLCreateAPIView.as_view(), name='service-create'),
    path('servicespl/<int:pk>/', ServicesPLRUDAPIView.as_view(), name='service'),
    path('servicespl/filter/', ServicesPLFilterView.as_view()),

    path('materialspl/', MaterialsPLListAPIView.as_view()),
    path('materialspl/create/', MaterialsPLCreateAPIView.as_view(), name='material-create'),
    path('materialspl/<int:pk>/', MaterialsPLRUDAPIView.as_view(), name='material'),
    path('materialspl/upload-photo/', MaterialsPhotoAPIView.as_view()),
    path('materialspl/upload-photos/', MaterialsPhotosAPIView.as_view()),
    ...
    path('request/filter/', RequestFilterView.as_view()),

    path('executor/', ExecutorListAPIView.as_view()),
    path('executor/create/', ExecutorCreateAPIView.as_view(), name='executor-create'),
    path('executor/<int:pk>/', ExecutorRUDAPIView.as_view(), name='executor'),
    path('executor/search/', ExecutorSearchFilterView.as_view()),
    ...
    path('chosenmaterials/filter/', ChosenMaterialsRangeFilterView.as_view()),
    ...
    path('workgroup/filter/', WorkGroupFilterView.as_view()),
    ...
    path('invoice/search/', InvoiceSearchFilterView.as_view()),
